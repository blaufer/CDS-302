...
print 'CREATE TABLE ASTRO (Preview text, Collection text, Obs_ID text, RA text, Dec text, Start_Date text, Instrument text, Int_Time text, Target_Name text, Filter text, Cal_Lev text, Obs_Type text, Min_Wavelength text, Max_Wavelength text, Proposal_ID text, P_I_Name text, Product_ID text, Data_Release text, Field_of_View text, Polygon text, Pixel_Scale text, Data_Type text, Moving_Target text, Provenance_Name text, Provenance_Keywords text, Intent text, Target_Type text, Target_Standard text, Meta_Release text, Sequence_Number text, Algorithm_Name text, Proposal_Title text, Proposal_Keywords text, IQ text, Instrument_Keywords text, Tau text, Molecule text, Transition text, Proposal_Project text, Band text, Prov_Reference text, Prov_Version text, Prov_Project text, Prov_Producer text, Prov_Run_ID text, Prov_Last_Executed text, Prov_Inputs text, Rest_frame_Energy text, planeID text, DOWNLOADABLE text, CAOM_Plane_URI text);'
